...
return [
    ...
    */
    ...
    'custom' => [
        'email' => [
            'required' => 'Necesitamos tu correo electrónico para continuar.',
            'email' => 'Por favor, introduce un correo electrónico válido.',
            'unique' => 'Este correo ya está registrado en nuestro sistema.',
        ],
        'password' => [
            'required' => 'La contraseña es necesaria.',
            'min' => 'Tu contraseña debe tener al menos :min caracteres.',
            'confirmed' => 'Las contraseñas no coinciden.',
            'regex' => 'Tu contraseña debe incluir al menos una letra mayúscula, una minúscula y un número.',
        ],
        'name' => [
            'required' => 'Por favor, dinos cómo te llamas.',
            'min' => 'Tu nombre debe tener al menos :min caracteres.',
            'max' => 'Tu nombre no puede tener más de :max caracteres.',
        ],
        'phone' => [
            'required' => 'Tu número de teléfono es necesario.',
        ...
        'terms' => [
            'required' => 'Debes aceptar nuestros términos y condiciones para continuar.',
        ],
    ],
