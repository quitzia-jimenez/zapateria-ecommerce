    ...
    <div class="ladoDerecho">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="grupoEntrada">
                ...
                <input id="email" type="email" placeholder="Ingresa tu email" class="entradaTexto @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            ...
            <div class="grupoEntrada">
                ...
                <input id="password" type="password" class="entradaTexto @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Ingresa tu contraseña">
            ...
            <div class="opciones">
                ...
                <a href="{{ route('password.request') }}" class="olvidoContrasena">¿Olvidaste tu contraseña?</a>
                @endif
            </div>
