            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <select class="form-select" name="order_status" id="order_status">
                                                <option value="ordenado" {{$order->status == 'ordenado' ? "selected" : ""}}>
                                                    Ordenado</option>
                                                <option value="enviado" {{$order->status == 'enviado' ? "selected" : ""}}>
                                                    Enviado</option>
                        ...
                        <div class="card w-100">
                            <div class="card-body p-4">
                                <h5 class="card-title fw-semibold mb-4">Comprobante de pago</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        @if($order->image_proof)
                                            <div class="mb-3">
                                                <label class="form-label"><strong>Comprobante:</strong></label>
                                                <div class="receipt-image">
                                                    <img src="{{ Storage::url($order->image_proof) }}" alt="Comprobante de pago"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"><strong>Código de Referencia:</strong></label>
                                            <p>{{$order->reference_code ?? 'No disponible'}}</p>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label"><strong>Estado del Comprobante:</strong></label>
                                            <p>
                                                @if($transaction->status == 'en_comprobacion')
                                                    <span class="badge bg-warning">En comprobación</span>
                                                @elseif($transaction->status == 'completada')
